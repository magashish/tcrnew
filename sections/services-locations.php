...
<section class="trc-locations section-pad" id="services-locations">
    <div class="container">
        ...
        <div class="row justify-content-center text-center mb-4">
            <div class="col-12 col-md-9 col-lg-7">
                ...
                <h2 class="trc-section-heading mt-2 mb-3">
                    Serving The Greater Ohio Region
                </h2>
                <p class="trc-section-body">
                    TRC is proud to serve the local community. While we are located in Toledo,
                    we travel to many cities across the state to ensure our neighbors have access
                    to the best transport services available.
                </p>
            </div>
        </div>
